const features = [
  {
    ...
    description:
      'Create professional events in minutes with our intuitive drag-and-drop builder.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'Effortlessly manage registrations, check-ins, and communicate with attendees.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'Track ticket sales, engagement metrics, and ROI with comprehensive dashboards.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'Promote your events with built-in email campaigns, social sharing, and SEO optimization.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'White-label your event pages with your logo, colors, and custom domain.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'Connect with CRM, payment gateways, calendar apps, and more via our API.',
  },
];
